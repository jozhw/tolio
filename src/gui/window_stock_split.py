...
class WindowStockSplit(customtkinter.CTk):
    ...
    def window_widgets(self):
        ...
        name_of_security_entry = customtkinter.CTkOptionMenu(self.ss_window, values=self.master.db.get_table_value("security_name"),
        ...
        ticker_entry = customtkinter.CTkOptionMenu(self.ss_window, values=self.master.db.get_table_value("security_ticker"),
        ...
        time_of_transaction_entry = customtkinter.CTkEntry(self.ss_window, placeholder_text="Leave empty or input in the format \"YYYY-MM-DD\".")
        time_of_transaction_entry.place(relx=0.18, rely=0.415, relwidth=0.8, relheight=0.07)

        amount_of_shares_entry = customtkinter.CTkEntry(self.ss_window, placeholder_text="Input only a whole number.")
        ...
        transaction_type_entry = customtkinter.CTkEntry(self.ss_window, textvariable=set_transaction_type_entry)
        ...
        # entry button
        entry_button = customtkinter.CTkButton(self.ss_window, text="Enter", command=lambda: self.master.gb.insert_transaction_into_database(entry_dic, split=True))
        entry_button.place(relx=0, rely=0.8, relwidth=1, relheight=0.07)

        # return to main menu and exit button
        return_main_button = customtkinter.CTkButton(self.ss_window, text="Close Window", command=self.ss_window.destroy)
        exit_button = customtkinter.CTkButton(self.ss_window, text="Exit Program", command=self.master.on_closing)
