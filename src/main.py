...
from gui_functionalities import GuiFunction



class App(customtkinter.CTk):
    customtkinter.set_appearance_mode(GuiFunction().get_previous_setting("config/set_settings.json", appearance_option=True))
    customtkinter.set_default_color_theme(GuiFunction().resource_path("config/sstyle.json"))
    ...
    def __init__(self):
        ...
        logo_path = PhotoImage(file=GuiFunction().resource_path("images/tolio_icon.png"))
        ...
        self.add_icon = customtkinter.CTkImage(dark_image = Image.open(GuiFunction().resource_path("images/add_dark.png")),
                                                        light_image = Image.open(GuiFunction().resource_path("images/add_light.png")))

        self.refresh_icon = customtkinter.CTkImage(dark_image = Image.open(GuiFunction().resource_path("images/refresh_dark.png")),
                                                        light_image = Image.open(GuiFunction().resource_path("images/refresh_light.png")))

        self.transfer_icon = customtkinter.CTkImage(dark_image = Image.open(GuiFunction().resource_path("images/transfer_dark.png")),
                                                        light_image = Image.open(GuiFunction().resource_path("images/transfer_light.png"))
                                                        )
        self.ss_icon = customtkinter.CTkImage(dark_image = Image.open(GuiFunction().resource_path("images/ss_dark.png")),
                                                        light_image = Image.open(GuiFunction().resource_path("images/ss_light.png")))

        self.documentation_icon = customtkinter.CTkImage(dark_image = Image.open(GuiFunction().resource_path("images/doc_dark.png")),
                                                        light_image = Image.open(GuiFunction().resource_path("images/doc_light.png")))
        ...
        self.appearance_options_set = customtkinter.StringVar(value=GuiFunction().get_previous_setting(GuiFunction().resource_path("config/set_settings.json"),appearance_option=True))  # set initial value
        ...
        self.transition_menu.set(GuiFunction().get_previous_setting(GuiFunction().resource_path("config/set_settings.json"),transition_menu=True))
        self.transition_menu.configure(command=self.tab_selection)
        self.tab_selection(GuiFunction().get_previous_setting(GuiFunction().resource_path("config/set_settings.json"),transition_menu=True))
    ...
    def tab_selection(self, value:str) -> None:
      ...
      elif value == "Individual Shares":
        self.show_individual_shares_window()
    ...
    def show_transaction_window(self) -> None:
        ...
        # insert transactions
        self.query_database(Database().get_transactions_table)
    ...
    def show_institutions_held_window(self) -> None:
        ...
        # insert transactions
        self.query_database(Database().get_institutions_held_table)
    ...
    def show_securities_window(self) -> None:
        ...
        # insert transactions
        self.query_database(Database().get_security_table)
    ...
    def show_stock_split_data_window(self) -> None:
        ...
        # insert transactions
        self.query_database(Database().get_stock_split_history)
    ...
    def show_individual_shares_window(self) -> None:
         # ================================= Tree View =================================
        ...
        type_label=customtkinter.CTkLabel(self.data_frame,text="Sold Date", anchor='w')
        type_label.place(relx=0.262,rely=0.3,relheight=0.4,relwidth=0.06,anchor=NW)
        type_entry=customtkinter.CTkEntry(self.data_frame, height=25)
        type_entry.place(relx=0.342,rely=0.4,relwidth=0.145,anchor=NW)
    ...
    def window_add_transaction(self) -> None:
        ...
        name_of_security_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("security_name"))
        name_of_security_entry.set(value="")
        name_of_security_entry.place(relx=0.16,rely=0.125,relwidth=0.82,relheight=0.05)

        ticker_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("security_ticker"))
        ticker_entry.set(value="")
        ticker_entry.place(relx=0.16,rely=0.225,relwidth=0.82,relheight=0.05)

        institution_name_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("institution"))
        ...
        # entry button
        entry_button=customtkinter.CTkButton(window, text="Enter", command=lambda: GuiFunction().insert_transaction_into_database(GuiFunction().edit_entry_dic(entry_dic)))
    ...
    def window_transfer_institution(self) -> None:
        ...
        name_of_security_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("name"))
        name_of_security_entry.set(value="")
        name_of_security_entry.place(relx=0.16,rely=0.125,relwidth=0.82,relheight=0.05)

        ticker_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("ticker"))
        ticker_entry.set(value="")
        ticker_entry.place(relx=0.16,rely=0.225,relwidth=0.82,relheight=0.05)

        from_institution_name_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("institution"))
        ...
        to_institution_name_entry = customtkinter.CTkComboBox(window, values=Database().get_table_value("institution"))
        ...
        # entry button
        entry_button=customtkinter.CTkButton(window, text="Enter", command=lambda: GuiFunction().insert_transaction_into_database(GuiFunction().edit_entry_dic(entry_dic, transfer = True), transfer= True))
        entry_button.place(relx=0,rely=0.825,relwidth=1,relheight=0.05)
    ...
    def window_stock_split(self) -> None:
        ...
        name_of_security_entry = customtkinter.CTkOptionMenu(window, values=Database().get_table_value("security_name"), fg_color =("#F9F9FA", "#343638"),
        button_color = ("#979DA2", "#565B5E"),
        button_hover_color = ("#6E7174", "#7A848D"))
        ...
        ticker_entry = customtkinter.CTkOptionMenu(window, values=Database().get_table_value("security_ticker"), fg_color =("#F9F9FA", "#343638"),
        button_color = ("#979DA2", "#565B5E"),
        button_hover_color = ("#6E7174", "#7A848D"))
        ...
        # entry button
        entry_button=customtkinter.CTkButton(window, text="Enter", command= lambda: GuiFunction().insert_transaction_into_database(entry_dic, split=True))
    ...
    def on_closing(self) -> None:
        GuiFunction().save_previous_setting(GuiFunction().resource_path("config/set_settings.json"), self.transition_menu.get(), self.appearance_options.get() )
        self.destroy()
